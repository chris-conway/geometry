    ...
    implements CoordinateSequence
{
  ...
  /**
   * @see jts.geom.CoordinateSequence#getDimension()
   */
  ...
  /**
   * @see jts.geom.CoordinateSequence#getCoordinate(int)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequence#toCoordinateArray()
   */
...
// testing - never cache
  ...
  /**
   * @see jts.geom.CoordinateSequence#getX(int)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequence#getY(int)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequence#getOrdinate(int, int)
   */
  ...
  public static class Double extends PackedCoordinateSequence {
    ...
    /**
     * @see jts.geom.CoordinateSequence#size()
     */
    public int size() {
    ...
    /**
     * @see jts.geom.PackedCoordinateSequence#setOrdinate(int,
     *      int, double)
     */
