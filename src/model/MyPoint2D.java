...
/******************************************************************************
 *  Compilation:  javac MyPoint2D.java
 *  Execution:    java MyPoint2D x0 y0 n
 ...
 *  Double with respect to -0.0 and +0.0, the MyPoint2D constructor converts
 ...
 *  @author Kevin Wayne
 */
public final class MyPoint2D implements Comparable<MyPoint2D> {

    /**
     * Compares two points by x-coordinate.
     */
    public static final Comparator<MyPoint2D> X_ORDER = new XOrder();

    /**
     * Compares two points by y-coordinate.
     */
    public static final Comparator<MyPoint2D> Y_ORDER = new YOrder();

    /**
     * Compares two points by polar radius.
     */
    public static final Comparator<MyPoint2D> R_ORDER = new ROrder();
     ...
     */
    public static double area2(MyPoint2D a, MyPoint2D b, MyPoint2D c) {
     ...
     * @return the comparator
     */
    public Comparator<MyPoint2D> atan2Order() {
     ...
     * @return the comparator
     */
    public Comparator<MyPoint2D> distanceToOrder() {
    ...
    private static class YOrder implements Comparator<MyPoint2D> {
        public int compare(MyPoint2D p, MyPoint2D q) {
            if (p.y < q.y) return -1;
            if (p.y > q.y) return +1;
            return 0;
    ...
    private static class ROrder implements Comparator<MyPoint2D> {
        public int compare(MyPoint2D p, MyPoint2D q) {
    ...
    private class Atan2Order implements Comparator<MyPoint2D> {
    ...
    private class PolarOrder implements Comparator<MyPoint2D> {
        public int compare(MyPoint2D q1, MyPoint2D q2) {
            ...
            else return -ccw(MyPoint2D.this, q1, q2);     // both above or below
    ...
    private class DistanceToOrder implements Comparator<MyPoint2D> {
        public int compare(MyPoint2D p, MyPoint2D q) {
     ...
     * @param that the other point
     */
    public void drawTo(MyPoint2D that) {
    }
}
