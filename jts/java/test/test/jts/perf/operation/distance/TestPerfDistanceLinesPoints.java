...
import jts.densify.Densifier;
import jts.geom.*;
import jts.operation.distance.DistanceOp;
import jts.operation.distance.IndexedFacetDistance;
import jts.util.GeometricShapeFactory;
import jts.geom.util.*;
import jts.io.WKTFileReader;
import jts.io.WKTReader;
import jts.util.Stopwatch;
