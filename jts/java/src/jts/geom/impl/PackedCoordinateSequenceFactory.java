    ...
    CoordinateSequenceFactory
{
  ...
  /**
   * @see jts.geom.CoordinateSequenceFactory#create(jts.geom.Coordinate[])
   */
  ...
  /**
   * @see jts.geom.CoordinateSequenceFactory#create(jts.geom.CoordinateSequence)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequenceFactory#create(double[],
   *      int)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequenceFactory#create(float[],
   *      int)
   */
  ...
  /**
   * @see jts.geom.CoordinateSequenceFactory#create(int, int)
   */
