...
public class MultiGenerator extends GeometryGenerator {
	 ...
	 * @see jts.generator.GeometryGenerator#create()
	 * 
	 * @see #BOX
	 * @see #VERT
	 * @see #HORZ
	...
	/**
	 * @see jts.generator.GeometryGenerator#setBoundingBox(jts.geom.Envelope)
	 */
	...
	/**
	 * @see jts.generator.GeometryGenerator#setDimensions(int)
	 */
	...
	/**
	 * @see jts.generator.GeometryGenerator#setGeometryFactory(jts.geom.GeometryFactory)
	 */
