...
import jts.algorithm.NonRobustCGAlgorithms;
import jts.algorithm.PointLocator;
import jts.geom.*;
import jts.geom.Coordinate;
import jts.geom.Geometry;
import jts.geom.GeometryFactory;
import jts.geom.Location;
import jts.geom.PrecisionModel;
import jts.io.WKTReader;
import jts.planargraph.DirectedEdge;
import jts.planargraph.Edge;
import jts.planargraph.Node;
import jts.util.UniqueCoordinateArrayFilter;
