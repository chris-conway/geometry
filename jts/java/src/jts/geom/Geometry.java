...
import jts.algorithm.*;
import jts.geom.util.*;
import jts.io.WKTWriter;
import jts.operation.*;
import jts.operation.buffer.BufferOp;
import jts.operation.distance.DistanceOp;
import jts.operation.linemerge.LineMerger;
import jts.operation.overlay.OverlayOp;
import jts.operation.union.UnaryUnionOp;
import jts.operation.overlay.snap.SnapIfNeededOverlayOp;
import jts.operation.predicate.RectangleIntersects;
import jts.operation.predicate.RectangleContains;
import jts.operation.relate.RelateOp;
import jts.operation.valid.IsValidOp;
import jts.util.Assert;
...
//      return other.intersection(this);
  ...
  protected void checkNotGeometryCollection(Geometry g) {
    ...
    if (g.getClass().getName().equals("jts.geom.GeometryCollection")) {
  ...
  {
    return getClass().equals(jts.geom.GeometryCollection.class);
  }
